...
The firefly algorithm is a nature-inspired, meta-heuristic optimization
...
distance.  Each firefly represents one solution to the optimization problem. We
...
optimize over 275 iterations. We used following parameters for all experiments:
...
\begin{table}[H]
  \centering
   \begin{tabular}{|c c c c|}
     ...
     \hline
  \end{tabular}
  \caption{Minimal errors after the given number of evaluations produced by optimizers on the DTLZ1 problem. Results are averaged over 10 subsequent runs.}
